...
# promptStyler
_C.TRAINER.PROMPTSTYLER = CN()
_C.TRAINER.PROMPTSTYLER.WEIGHT_DIR_PATH = "weight/promptStyler/checkpoint"
_C.TRAINER.PROMPTSTYLER.CHECK_POINT_NAME = "model.pth"
_C.TRAINER.PROMPTSTYLER.TRAIN_STYLE = False
